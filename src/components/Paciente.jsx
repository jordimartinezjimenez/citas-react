    ...
    return (
        <div className="mx-5 my-10 bg-white shadow-md px-5 py-10 rounded-xl">
            ...
            <div className="flex justify-between mt-10">
                <button type="button" className="py-2 px-10 bg-pink-600 hover:bg-rose-700 text-white font-bold uppercase rounded-lg" 
                onClick={() => setPaciente(paciente)}>Editar</button>
                <button type="button" className="py-2 px-10 bg-slate-600 hover:bg-rose-700 text-white font-bold uppercase rounded-lg" 
